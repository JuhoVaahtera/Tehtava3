...
class Asiakas:
    """
    init(self, nimi, ika): Luo uuden Asiakas olion nimen, asiakasnumeron ja iän avulla
    luo_nro(self): Luo uuden asiakasnumeron ja palauttaa sen arvon
    set_nimi(self, uusi_nimi): Asettaa asiakkaan nimen uudeksi annetun nimen perusteella. Jos uusi nimi on tyhjä, heittää ValueError-poikkeuksen.
    """
...
class Palvelu:
    """
    init(self, tuotenimi): Luo uuden Palvelu-olion tuotenimen ja asiakaslistan avulla
    luo_asiakasrivi(self, asiakas): Muodostaa stringin, joka kuvaa annetun asiakkaan nimeä, asiakasnumeroa ja ikää
    lisaa_asiakas(self, asiakas): Lisää annetun asiakkaan listalle. Jos asiakas on "None", heittää ValueError poikkeuksen
...
class ParempiPalvelu(Palvelu):
    """
    init(self, tuotenimi): Alustaa uuden ParempiPalvelu-olion tuotenimen, asiakaslistan ja etulistauksen avulla
    lisaa_etu(self, etu): Lisää uuden edun etulistaukseen
    poista_etu(self, etu): Poistaa annetun edun etulistauksesta, jos se löytyy
